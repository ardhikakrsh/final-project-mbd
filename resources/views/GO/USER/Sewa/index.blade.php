                            ...
                            <tbody>
                                @foreach ($sewas as $sewa)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('user.order.show', $sewa) }}" class="mx-2" data-bs-toggle="tooltip"
                                                data-bs-original-title="View Detail">
                                                <i class="fas fa-eye text-secondary"></i>
                                            </a>
                                            <a href="{{ route('user.order.pay', $sewa->id) }}" class="mx-2 rounded-2 bg-success p-1 px-4" data-bs-toggle="tooltip"

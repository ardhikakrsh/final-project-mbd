<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ url('/') }}">
            <img src="{{ asset('GO-RENT.svg') }}" class="navbar-brand-img h-100" alt="logo">
            <span class="ms-3 fs-3 font-weight-bold">GO-RENT</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is(auth()->user()->role->value . '/dashboard') ? 'active' : '' }}"
                    href="{{ url(auth()->user()->role->value . '/dashboard') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            ...
            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">
                    {{ auth()->user()->role->value }} Dashboard</h6>
            </li>
            @if (auth()->user()->isAdmin())
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/kendaraans*') ? 'active' : '' }}"
                        href="{{ route('admin.kendaraans.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                        ...
                        <span class="nav-link-text ms-1">Kendaraans</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/pembayarans*') ? 'active' : '' }}"
                        ...
                        <span class="nav-link-text ms-1">Pembayarans</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/pengembalians*') ? 'active' : '' }}"
                        href="{{ route('admin.pengembalians.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Pengembalians</span>
                    </a>
                </li>
            @elseif (auth()->user()->isOwner())
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('owner/kendaraan*') ? 'active' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('owner/order*') ? 'active' : '' }}"
                        href="{{ route('owner.order.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                <title>Order</title>
